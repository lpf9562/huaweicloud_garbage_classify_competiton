...
from keras.applications.mobilenetv2 import utils
...
def ResNet50(include_top=True,
    ...
    x=resnet_net(img_input,include_top,classes,pooling)
...
def resnet_net(img_input,include_top,classes,pooling):
    if backend.image_data_format() == 'channels_last':
        bn_axis = 3
    else:
        bn_axis = 1
